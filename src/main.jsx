...
const iconMap = { Zap, Wifi, PackageOpen, Droplets, Utensils, Bath, Sofa, Trash2, ShoppingBasket };
const resolveIcon = (icon) => typeof icon === 'function' ? icon : (iconMap[icon && icon.displayName] || ShoppingBasket);
